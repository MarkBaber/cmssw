...
SUSY_HLT_HT200_alphaT0p51 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPreFilter                = cms.InputTag('hltHT150CaloAlphaT0p51', '', 'TEST'),
  TriggerFilter                   = cms.InputTag('hltPFHT200PFAlphaT0p51', '', 'TEST'),
...
SUSY_HLT_HT200_alphaT0p57 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerFilter                   = cms.InputTag('hltPFHT200PFAlphaT0p57', '', 'TEST'),
  PtThrJet            = cms.untracked.double(40.0),
  EtaThrJet           = cms.untracked.double(3.0),
  caloHtThrTurnon     = cms.untracked.double(200),
...
SUSY_HLT_HT250_alphaT0p55 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_v'),
  TriggerPreFilter = cms.InputTag('hltHT225CaloAlphaT0p53', '', 'TEST'),
  TriggerFilter    = cms.InputTag('hltPFHT250PFAlphaT0p55', '', 'TEST'),
  PtThrJet = cms.untracked.double(40.0),
  EtaThrJet = cms.untracked.double(3.0),
...
SUSY_HLT_HT300_alphaT0p53 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_v'),
  TriggerPreFilter = cms.InputTag('hltHT275CaloAlphaT0p525', '', 'TEST'), 
  TriggerFilter    = cms.InputTag('hltPFHT300PFAlphaT0p53', '', 'TEST'),
  PtThrJet = cms.untracked.double(40.0),
  EtaThrJet = cms.untracked.double(3.0),
...
SUSY_HLT_HT350_alphaT0p52 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_v'),
  TriggerPreFilter = cms.InputTag('hltHT325CaloAlphaT0p515', '', 'TEST'),
  TriggerFilter    = cms.InputTag('hltPFHT350PFAlphaT0p52', '', 'TEST'),
  PtThrJet = cms.untracked.double(40.0),
  EtaThrJet = cms.untracked.double(3.0),
...
SUSY_HLT_HT400_alphaT0p51 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerFilter    = cms.InputTag('hltPFHT400PFAlphaT0p51', '', 'TEST'),
  PtThrJet = cms.untracked.double(40.0),
  EtaThrJet = cms.untracked.double(3.0),
...
SUSY_HLT_HT200_alphaT0p63 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_v'),
  TriggerPreFilter                = cms.InputTag('hltHT175CaloAlphaT0p59', '', 'TEST'),
  TriggerFilter                   = cms.InputTag('hltPFHT200PFAlphaT0p63', '', 'TEST'),
  PtThrJet            = cms.untracked.double(40.0),
  EtaThrJet           = cms.untracked.double(3.0),
  caloHtThrTurnon     = cms.untracked.double(200),
  caloAlphaTThrTurnon = cms.untracked.double(0.61),
...
SUSY_HLT_HT250_alphaT0p58 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_v'),
  TriggerPreFilter = cms.InputTag('hltHT225CaloAlphaT0p55', '', 'TEST'),
  TriggerFilter = cms.InputTag('hltPFHT250PFAlphaT0p58', '', 'TEST'),
  PtThrJet = cms.untracked.double(40.0),
  EtaThrJet = cms.untracked.double(3.0),
  pfAlphaTThrTurnon = cms.untracked.double(0.6),
  pfHtThrTurnon = cms.untracked.double(275),
...
SUSY_HLT_HT300_alphaT0p54 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_v'),
  TriggerPreFilter = cms.InputTag('hltHT250CaloAlphaT0p53', '', 'TEST'), 
  TriggerFilter = cms.InputTag('hltPFHT300PFAlphaT0p54', '', 'TEST'),
  PtThrJet = cms.untracked.double(40.0),
  EtaThrJet = cms.untracked.double(3.0),
  pfAlphaTThrTurnon = cms.untracked.double(0.56),
  pfHtThrTurnon = cms.untracked.double(325),
...
SUSY_HLT_HT350_alphaT0p53 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_v'),
  TriggerPreFilter = cms.InputTag('hltHT300CaloAlphaT0p51', '', 'TEST'),
  TriggerFilter = cms.InputTag('hltPFHT350PFAlphaT0p53', '', 'TEST'),
  PtThrJet = cms.untracked.double(40.0),
  EtaThrJet = cms.untracked.double(3.0),
  pfAlphaTThrTurnon = cms.untracked.double(0.55),
  pfHtThrTurnon = cms.untracked.double(375),
...
SUSY_HLT_HT400_alphaT0p52 = cms.EDAnalyzer("SUSY_HLT_alphaT",
  ...
  TriggerPathAuxiliaryForHadronic = cms.string('HLT_IsoMu24_eta2p1_v'),
  TriggerPreFilter = cms.InputTag('hltHT325CaloAlphaT0p51', '', 'TEST'),
  TriggerFilter = cms.InputTag('hltPFHT400PFAlphaT0p52', '', 'TEST'),
  PtThrJet = cms.untracked.double(40.0),
  EtaThrJet = cms.untracked.double(3.0),
  pfAlphaTThrTurnon = cms.untracked.double(0.54),
  pfHtThrTurnon = cms.untracked.double(425),
